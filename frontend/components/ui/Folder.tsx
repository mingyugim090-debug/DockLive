...
> = {
  ...
  md: {
    ...
    tabRight: 'w-[10px] h-4 rounded-tr-[32px]',
    tabBridge: 'w-[10px] h-[10px]',
    flapBody: 'h-12',
  ...
  lg: {
    ...
    tabLeft: 'w-16 h-[22px] rounded-tl-xl',
    tabRight: 'w-[13px] h-[22px] rounded-tr-[40px]',
    tabBridge: 'w-[13px] h-[13px]',
    flapBody: 'h-16',
      ...
      <div className="absolute right-0 bottom-0 left-0 z-20">
        <div className="flex items-end">
          ...
          <div
            ...
            style={{
              maskImage: 'radial-gradient(200% 200% at 100% 0%, transparent 50%, black 50%)',
              WebkitMaskImage: 'radial-gradient(200% 200% at 100% 0%, transparent 50%, black 50%)',
            }}
          />
        </div>
