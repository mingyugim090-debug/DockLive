...
const plans = [
  { name: 'Starter', credits: '월 30건', price: '무료 체험', desc: '공고문 작성 흐름을 팀 내부에서 검토할 때 적합합니다.' },
  { name: 'Team', credits: '월 300건', price: '기관용', desc: '부서 단위로 모집공고와 지원사업 공고를 반복 작성할 때 적합합니다.' },
  { name: 'Enterprise', credits: '맞춤 제공', price: '별도 협의', desc: '대학, 지자체, 공공기관의 보안·서식·결재 환경에 맞춰 운영합니다.' },
];
  ...
  return (
    <div className="space-y-6">
      <section className="rounded-3xl border border-[#DDE7E2] bg-[#F6FAF8] px-6 py-7 shadow-sm lg:px-8">
        ...
        <h2 className="mt-2 text-3xl font-bold text-[#24312D]">공고문 생성 크레딧을 관리하세요.</h2>
        <p className="mt-3 max-w-3xl text-sm leading-7 text-[#65736E]">
          현재 보유 크레딧과 기관 규모에 맞는 사용량을 확인할 수 있습니다.
        </p>
      </section>
