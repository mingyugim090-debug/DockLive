...
| ID | Task | Status |
| --- | --- | --- |
| P5-01 | Public announcement feed | Planned |
| P5-02 | Opportunity source directory | Planned |
| P5-03 | Team recruiting board | Planned |
| P5-04 | Student profile and participation history | Planned |
| P5-05 | Interest-based recommendation | Planned |

Community v2 must not block Agent MVP work.
