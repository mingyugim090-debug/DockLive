...
This file preserves the InsForge-specific MCP and SDK guidance. Use it only when a task touches InsForge auth, database, storage, functions, AI integration, deployment, or SDK code.
