...
def get_mock_result() -> dict:
    ...
    return {
        ...
        "checklist": [
            {
                "label": "참가 신청서",
                "category": "required",
                "description": "공고문에 첨부된 지정 양식 사용",
                "file_format": "HWP, PDF",
            },
            {
                "label": "사업계획서",
                "category": "required",
                "description": "A4 10매 이내, 문제 정의와 실행 계획 포함",
                "file_format": "HWP, PDF",
            },
            {
                "label": "팀원 재학증명서",
                "category": "required",
                "description": "팀 참가 시 팀원 전원 제출",
                "file_format": "PDF",
            },
            {
                "label": "포트폴리오",
        ...
        "benefits": [
            "대상 1팀 상금 500만원",
            "우수팀 창업 멘토링 및 후속 투자 연계",
            "공유오피스 6개월 이용권",
        ],
        "cautions": [
            "타 공모전 수상작과 동일한 아이디어는 심사에서 제외될 수 있음",
            "제출 마감 이후에는 서류 수정이 불가함",
        ],
        "uncertain_fields": [],
    }
