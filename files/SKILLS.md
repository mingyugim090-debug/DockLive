...
| AI | Anthropic SDK | 0.28.x | Claude API 연동 |
...
async def analyze_announcement(text: str, today: str) -> dict:
    """공고문 텍스트를 Claude API로 분석합니다."""
...
pip install fastapi uvicorn python-multipart PyMuPDF anthropic pydantic-settings httpx
